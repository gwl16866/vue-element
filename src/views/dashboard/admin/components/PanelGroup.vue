    ...
    <el-col :xs="12" :sm="12" :lg="6" class="card-panel-col">
      <div class="card-panel" @click="handleSetLineChartData('shopping')">
        ...
        <div class="card-panel-description">
          ...
          <count-to :start-val="0" :end-val="shopping" :duration="3600" class="card-panel-num" />
        </div>
      </div>
    </el-col>
  </el-row>
...
data(){
 ...
 usercount() {
      var a = this
      this.$axios.get('http://localhost:8081/system/user/count')
        .then(res => {
          a.peoples = res.data
        })
        .catch(err => {
    ...
    refundinformation(){
      var a = this
      this.$axios.get('http://localhost:8081/system/user/returnmoney')
        .then(res => {
          a.message = res.data
        })
        .catch(err => {
    ...
    sales(){
      var a = this
      this.$axios.get('http://localhost:8081/system/user/sales')
        .then(res => {
          a.money = res.data
        })
        .catch(err => {
    ...
    ordercount(){
       var a = this
      this.$axios.get('http://localhost:8081/system/user/ordercount')
        .then(res => {
          a.shopping = res.data
        })
        .catch(err => {
